package eryaz.software.kup.ui.dashboard.counting.firstCounting.firstCountingDetail.countingInfo
...
import eryaz.software.kup.databinding.FragmentInfoFirstCountingBinding
...
class InfoFirstCountingFragment : BaseFragment() {
    ...
    private val productEdtAdapter by lazy(LazyThreadSafetyMode.NONE) {
        eryaz.software.kup.ui.dashboard.counting.adapter.InfoProductEdtAdapter().also {
