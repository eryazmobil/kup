package eryaz.software.kup.ui.dashboard.outbound.orderPicking.orderPickingDetail
    ...
    fun getShelfByCode() {
        executeInBackground(
            ...
            workActivityRepo.getShelfByCode(
                ...
                showError(
                    ErrorDialogDto(
                        title = stringProvider.invoke(eryaz.software.kup.data.R.string.error),
                        message = stringProvider.invoke(eryaz.software.kup.data.R.string.msg_shelf_not_found)
                    )
                )
            }
        }
