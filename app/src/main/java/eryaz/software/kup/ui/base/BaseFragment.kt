package eryaz.software.kup.ui.base
...
import eryaz.software.kup.data.enums.SoundEnum
import eryaz.software.kup.data.models.dto.ConfirmationDialogDto
import eryaz.software.kup.util.StatusBarUtil.changeStatusBarMode
import eryaz.software.kup.util.dialogs.ConfirmationDialog
import eryaz.software.kup.util.dialogs.ErrorDialog
import eryaz.software.kup.util.dialogs.ProgressDialog
import eryaz.software.kup.util.dialogs.WarningDialog
import eryaz.software.kup.util.extensions.appCompatActivity
import eryaz.software.kup.util.extensions.changeWindowBackground
import eryaz.software.kup.util.extensions.getColorAttrs
import eryaz.software.kup.util.extensions.getColorCompat
import eryaz.software.kup.util.extensions.getColorInt
import eryaz.software.kup.util.extensions.observe
import eryaz.software.kup.util.extensions.supportActionBar
...
open class BaseFragment : Fragment() {
    ...
    open fun playSound(type: SoundEnum) {
        val rowResId = when (type) {
            SoundEnum.Success -> eryaz.software.kup.data.R.raw.success_sound
            SoundEnum.Failure -> eryaz.software.kup.data.R.raw.fail_sound
        }
